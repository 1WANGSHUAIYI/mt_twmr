data <- read.csv("D:/GTEx/1Adipose_Subcutaneous.v10.eQTLs.signif_pairs.csv",header = TRUE, sep = ",", stringsAsFactors = FALSE)
...
for (i in 1:length(genes)){
  ...
  tryCatch(
    {clumtest6 <- ieugwasr::ld_clump_local(dat = dat,clump_r2=0.01,clump_kb=10000,clump_p=1,
                                           bfile = "D:/GTEx_Analysis_v8_eQTL/g1000_eur/g1000_eur", #EUR
